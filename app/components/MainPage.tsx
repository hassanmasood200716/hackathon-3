...
const MainPage = () => {
    return (
        <div className='flex h-[60vh] bg-[#F6F7F9]'>
            <div className="relative w-full md:w-1/2 m-8 mr-8">
                <div className="h-[50vh] w-full rounded-xl bg-cover bg-center bg-no-repeat"
                ...
                <div className="absolute top-0 left-0 w-full h-full md:flex">
                    <div className=' flex justify-start items-start flex-col p-5 md:p-10'>
                        ...
                        <div className='flex justify-end items-end md:h-[50vh]'>
                            <Image src="/images/car1.png" alt='carimage' width={700} height={700} />
                        </div>
                </div>
            </div>
            <div className="relative hidden md:block w-1/2 m-8 mr-8">
                <div className="h-[50vh] w-full rounded-xl bg-cover bg-center bg-no-repeat"
